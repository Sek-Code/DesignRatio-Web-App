          ...
          {teaProducts.map((tea) => (
            <CarouselItem key={tea.id}>
              <div>
                ...
                <div className="border-none shadow-lg rounded-3xl overflow-hidden">

                  <div className="relative flex flex-col items-center justify-center p-0 overflow-hidden rounded-lg h-[600px]">
                    <img 
                        src={tea.image} 
                        alt={tea.name} 
