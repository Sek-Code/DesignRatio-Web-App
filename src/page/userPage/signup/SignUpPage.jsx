...
export default function SignUpPage() {
  return (
    <main className="mx-auto w-full lg:max-w-[980px] px-4 md:px-8 pt-28 pb-16 flex-1">
      ...
      <div className="mt-14 flex justify-center gap-6">
        <input
          className="w-28 py-2 rounded-xl bg-amber-950 hover:bg-[var(--color-matcha)] text-white font-medium shadow-md"
          type="button"
          value="Login"
          onClick={() => (window.location.href = "/signin")}/>
        <input
          className="w-28 py-2 rounded-xl bg-gray-400 hover:bg-gray-500 text-white font-medium shadow-md"
          type="button"
          value="Sign Up"
